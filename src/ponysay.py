...
class Ponysay():
    ...
    def run(self, args):
        ...
        elif self.__test_nfdnf('--Quoters', ('--quoters', '++quoters')):  self.quoters(True, True)
        elif self.__test_nfdnf('--quoters'):                              self.quoters(True, False)
        elif self.__test_nfdnf('++quoters'):                              self.quoters(False, True)
    ...
    def __getSelectedPonies(self, args, selection):
        ...
        both = standard + extra
        for (opt, ponies, quotes) in [('-f', standard, False), ('+f', extra, False), ('-F', both, False),
                                      ('-q', standard, True),  ('+q', extra, True), ('-Q', both, True)]:
