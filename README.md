...
__A:__ We use blocks for printing the ponies, if the blocks are unalignated or you not use a __real__ monospaced font with aligned blocks try another monospaced font like 'fixed [misc]' or 'Liberation Mono'.
